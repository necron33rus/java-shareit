...
class ItemServiceTest {
    ...
    void updateNotExistsItem() {
        when(entityUtils.getItemIfExists(anyLong())).thenThrow(new NotFoundException("Item with id=" + 1L + " not exists"));
        var exception = assertThrows(NotFoundException.class, () -> itemService.update(new ItemDto(), 1L, 1L));
    ...
    @Test
    void addCommentWithOutBookingExists() {
