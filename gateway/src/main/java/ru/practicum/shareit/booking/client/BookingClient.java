...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> findByBookerAndState(long userId, String state, int from, int size) {
        return get("?state=" + state + "&from=" + from + "&size=" + size, userId);
    }

    public ResponseEntity<Object> findByOwnerAndState(long userId, String state, int from, int size) {
